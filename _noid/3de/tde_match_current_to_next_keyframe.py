#
#
# 3DE4.script.name:	Match Current To Next Keyframe...
...
#
# 3DE4.script.comment:	Match Current To Next Keyframe...
#
#
			...
			for point in pl:
				...
				if keyframe == 1:
					...
					if status == "POINT_KEYFRAME" or status == "POINT_KEYFRAME_END":
						...
						tde4.postQuestionRequester("Match Current To Next Keyframe...","Warning, Create A Keyframe To Improve...","Ok")
				else:
					tde4.postQuestionRequester("Match Current To Next Keyframe...","Warning, No Next Keyframe...","Ok")
		else:
			tde4.postQuestionRequester("Match Current To Next Keyframe...","Warning, Select At Least 1 Point...","Ok")
except:
