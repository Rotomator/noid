	...
	if ret==1:
		...
		if path!=None:
			...
			if not f.closed:
				...
				f.write("chunk.accuracy_cameras = PhotoScan.Vector( (" + tde4.getWidgetValue(req,"accuracy_position") +"," + tde4.getWidgetValue(req,"accuracy_position") + "," + tde4.getWidgetValue(req,"accuracy_position") +") )\n")
				f.write("chunk.accuracy_cameras_ypr = PhotoScan.Vector( (" + tde4.getWidgetValue(req,"accuracy_rotation") +"," + tde4.getWidgetValue(req,"accuracy_rotation") + "," + tde4.getWidgetValue(req,"accuracy_rotation") +") )\n")
